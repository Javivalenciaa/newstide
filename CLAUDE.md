...
- 🔴 EN CURSO: Internal linking persistente (`related_articles jsonb` guardado en Supabase + sidebar de relacionados en los 4 `page.tsx`). Ver `docs/gaps.md` para el detalle exacto.
- 🔴 Pendiente: topic clusters + pillar pages, content refresh pipeline, FAQ/HowTo schema, OG images dinámicas, GSC tracking a Supabase, fix categorías EN/ES.

Ver lista completa de gaps priorizados por impacto en `docs/gaps.md`.
