    ...
    <div style={{ minHeight: '100vh', padding: '120px 0 100px' }}>
      ...
      <div className="container" style={{ maxWidth: 640, margin: '0 auto' }}>
        ...
        <div style={{ fontSize: 16, lineHeight: 2, color: 'rgba(240,240,238,0.85)' }}>
          ...
          <p><strong>Editorial (errors, corrections):</strong> <a href="mailto:newstideco@gmail.com" style={{ color: 'var(--cyan)' }}>newstideco@gmail.com</a></p>
          <p><strong>Privacy:</strong> <a href="mailto:newstideco@gmail.com" style={{ color: 'var(--cyan)' }}>newstideco@gmail.com</a></p>
          <p><strong>Advertising &amp; partnerships:</strong> <a href="mailto:newstideco@gmail.com" style={{ color: 'var(--cyan)' }}>newstideco@gmail.com</a></p>
        </div>
