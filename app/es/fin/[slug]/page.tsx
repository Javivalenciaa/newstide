...
const AUTHOR_PAGE_ES = `https://www.newstide.news/es/autores/${AUTHOR_SLUG}`
...
export async function generateMetadata(
  ...
  const images = article.cover_image_url
    ...
    : [{ url: 'https://www.newstide.news/og-image.png', width: 1200, height: 630, alt: 'NewsTide Finanzas' }]
